...
export default {
            ...
            validator: function(value) {
                return (
                    [
                        ...
                        "ease-out",
                        "ease-in-out",
                    ].indexOf(value) !== -1 || value.includes("cubic-bezier")
                );
            },
            default: "ease",
        },
    ...
    computed: {
        ...
        transitionStyle() {
            ...
            if (this.adjustableHeight) {
                return `${transtion}, height ${speed} ${this
                    .adjustableHeightEasing || this.easing}`;
            }
    ...
    methods: {
        ...
        getCarouselWidth() {
            ...
            for (let i = 0; i < carouselInnerElements.length; i++) {
                if (carouselInnerElements[i].clientWidth > 0) {
                    this.carouselWidth =
                        carouselInnerElements[i].clientWidth || 0;
                }
            }
        ...
        getCarouselHeight() {
            ...
            const slideOffset =
                this.currentPerPage * (this.currentPage + 1) - 1;
